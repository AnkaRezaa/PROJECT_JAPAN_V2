    ...
    if (result) {
        ...
        return (
            <>
                ...
                <main className="min-h-screen bg-[#f3f5f7] px-4 py-8 text-gray-900 dark:bg-gray-950 dark:text-gray-100 sm:px-6 lg:py-12">
                    <div className="mx-auto max-w-4xl">
                        <section className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
                            ...
                            <div className="p-5 sm:p-8">
                                <div className="flex flex-col gap-5 border-b border-gray-200 pb-7 dark:border-gray-700 sm:flex-row sm:items-start sm:justify-between">
                                    <div>
                                        <p className="text-xs font-bold uppercase text-gray-500 dark:text-gray-400">Hasil ujian mingguan</p>
                                        <h1 className="mt-2 text-2xl font-bold sm:text-3xl">{quiz.title || 'Ujian Mingguan'}</h1>
                                        <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">{result.message}</p>
                                    </div>
                                    <div className={`min-w-32 rounded-lg border px-5 py-4 text-center ${passed ? 'border-emerald-200 bg-emerald-50 dark:border-emerald-900 dark:bg-emerald-950/40' : 'border-red-200 bg-red-50 dark:border-red-900 dark:bg-red-950/40'}`}>
                                        <p className="text-xs font-bold uppercase text-gray-500 dark:text-gray-400">Nilai akhir</p>
                                        <p className={`mt-1 text-4xl font-bold ${passed ? 'text-emerald-700 dark:text-emerald-300' : 'text-red-700 dark:text-red-300'}`}>{result.score}</p>
                                        <p className="mt-1 text-xs font-semibold text-gray-600 dark:text-gray-300">{passed ? 'Lulus' : 'Belum lulus'}</p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
                                    {[
                                        ...
                                        <div key={label} className="rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-800/70">
                                ...
                                <div className="mt-8 space-y-4">
                                    ...
                                    {reviews.map((review, index) => (
                                        <article key={review.question_id} className={`rounded-lg border p-4 sm:p-5 ${review.is_correct ? 'border-emerald-200 bg-emerald-50/50 dark:border-emerald-900 dark:bg-emerald-950/25' : 'border-red-200 bg-red-50/50 dark:border-red-900 dark:bg-red-950/25'}`}>
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    <JapaneseReading japanese={review.question} reading={review.question_reading} className="mt-2 font-semibold text-gray-900 dark:text-white" />
                                                    <dl className="mt-4 grid gap-3 text-sm sm:grid-cols-2">
                                                        <div>
                                                            <dt className="text-xs font-bold uppercase text-gray-500">Jawaban Anda</dt>
                                                            <dd className="mt-1 text-gray-800 dark:text-gray-200">{review.user_answer || 'Tidak dijawab'}</dd>
                                                        </div>
                                                        <div>
                                                    ...
                                                    {review.explanation && (
                                                        <div className="mt-3 border-t border-gray-200 pt-3 text-sm text-gray-600 dark:border-gray-700 dark:text-gray-300">
                                ...
                                <div className="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                                    {!passed && (
                                        <button
                                            ...
                                            className="h-11 rounded-md border border-gray-300 px-5 text-sm font-bold text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
                                        >
                                            Kerjakan ulang
                                        </button>
                                    )}
        ...
        <>
            ...
            <div className="min-h-screen bg-surface-muted text-gray-900 dark:bg-gray-950 dark:text-gray-100">
                <header className="sticky top-0 z-40 border-b border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    <div className="mx-auto flex max-w-7xl items-center gap-3 px-3 py-3 sm:px-6">
                        <button
                            ...
                            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-gray-200 text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800"
                        ...
                        <div className={`flex h-10 items-center gap-2 rounded-md border px-3 text-sm font-bold ${hasTimeLimit && secondsLeft <= 60 ? 'border-red-300 bg-red-50 text-red-700 dark:border-red-900 dark:bg-red-950/40 dark:text-red-300' : 'border-gray-200 bg-gray-50 text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200'}`}>
                ...
                <main className="mx-auto grid max-w-7xl gap-5 px-3 py-5 sm:px-6 lg:grid-cols-[minmax(0,1fr)_260px] lg:py-8">
                    <div className="min-w-0">
                        <section className="mb-5 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900 sm:p-6">
                            <div className="flex items-start gap-3">
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-brand-50 text-brand-700 dark:bg-[#12351f] dark:text-green-200">
                        ...
                        {attemptError && (
                            <div className="mb-5 rounded-lg border border-red-200 bg-red-50 p-4 text-sm font-semibold text-red-700 dark:border-red-900 dark:bg-red-950/40 dark:text-red-300">
                                {attemptError}
                            </div>
                        )}
                        ...
                        {attemptStarting ? (
                            <div className="rounded-lg border border-gray-200 bg-white p-10 text-center shadow-sm dark:border-gray-800 dark:bg-gray-900">
                                ...
                                <p className="mt-3 text-sm font-semibold text-gray-600 dark:text-gray-300">Menyiapkan sesi ujian...</p>
                            </div>
                        ) : (
                                ...
                                {questions.map((question, index) => {
                                    ...
                                    return (
                                        <article
                                            ...
                                            className={`scroll-mt-24 rounded-lg border bg-white shadow-sm dark:bg-gray-900 ${isFlagged ? 'border-amber-300 dark:border-amber-700' : 'border-gray-200 dark:border-gray-800'}`}
                                        >
                                            <div className="flex items-center justify-between gap-3 border-b border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-800 dark:bg-gray-800/60 sm:px-6">
                                                ...
                                                <button
                                                    ...
                                                    className={`flex h-9 items-center gap-1.5 rounded-md border px-3 text-xs font-bold ${isFlagged ? 'border-amber-300 bg-amber-50 text-amber-700 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-300' : 'border-gray-200 bg-white text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-800'}`}
                                                >
                                            ...
                                            <div className="p-4 sm:p-6">
                                                ...
                                                <JapaneseReading japanese={question.question} reading={question.question_reading} className="whitespace-pre-wrap text-base font-semibold leading-7 text-gray-900 dark:text-white sm:text-lg" />
                                                ...
                                                {question.type === 'multiple_choice' ? (
                                                    <div className="mt-5 grid gap-3">
                                                        {(question.options || []).map((option, optionIndex) => (
                                                            <label
                                                                ...
                                                                className={`flex cursor-pointer items-start gap-3 rounded-lg border p-3.5 transition ${answers[question.id] === option ? 'border-brand-500 bg-brand-50 dark:border-green-700 dark:bg-[#12351f]' : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50 dark:border-gray-700 dark:hover:border-gray-600 dark:hover:bg-gray-800'}`}
                                                            >
                                                                <input
                                                                    type="radio"
                                                                ...
                                                                />
                                                                <span className="text-sm leading-6 text-gray-800 dark:text-gray-200">
                                                    ...
                                                    <div className="mt-5">
                                                        ...
                                                        <input
                                                            ...
                                                            className="h-12 w-full rounded-lg border border-gray-300 bg-white px-4 text-sm text-gray-900 focus:border-focus focus:ring-focus dark:border-gray-700 dark:bg-gray-950 dark:text-white"
                        ...
                        {!attemptStarting && (
                            <div className="mt-5 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900 sm:flex sm:items-center sm:justify-between sm:p-5">
                                <div>
                    ...
                    <aside className="hidden lg:block">
                        <div className="sticky top-24 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                            ...
                            <div className="mt-5 space-y-2 border-t border-gray-200 pt-4 text-xs text-gray-600 dark:border-gray-700 dark:text-gray-300">
                ...
                <div className="sticky bottom-0 z-30 border-t border-gray-200 bg-white px-3 py-2 shadow-[0_-4px_12px_rgba(0,0,0,0.05)] dark:border-gray-800 dark:bg-gray-900 lg:hidden">
            ...
            {showSubmitDialog && (
                <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 p-0 sm:items-center sm:p-4">
                    <div className="w-full rounded-t-xl bg-white p-5 text-gray-900 shadow-xl dark:bg-gray-900 dark:text-gray-100 sm:max-w-md sm:rounded-lg sm:p-6">
                        ...
                        <div className="mt-4 grid grid-cols-3 gap-2">
                            {[
                                ...
                                <div key={label} className="rounded-md border border-gray-200 bg-gray-50 p-3 text-center dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="mt-5 flex gap-3">
                            <button
                                ...
                                className="h-11 flex-1 rounded-md border border-gray-300 text-sm font-bold text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
                            >
                                Periksa lagi
                            </button>
                            <button
