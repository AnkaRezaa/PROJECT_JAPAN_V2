...
export default function CertificateTemplate({ certificate, user }) {
    ...
    return (
        <div id="certificate-content" className="w-full max-w-3xl mx-auto bg-white border-4 border-amber-400 rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-12 relative overflow-hidden shadow-2xl" style={{ fontFamily: "'Noto Serif JP', 'Georgia', serif" }}>
            ...
            <div className="text-center relative z-10 mb-8">
                ...
                <h1 className="text-2xl sm:text-4xl font-black text-gray-900 tracking-tight mb-2">SERTIFIKAT KELULUSAN</h1>
                <div className="flex items-center justify-center gap-3">
                    <div className="w-16 h-0.5 bg-amber-400"></div>
                    <span className="text-xs sm:text-sm font-black text-amber-600 tracking-[0.3em] uppercase">TOKU-UP Academy</span>
                    <div className="w-16 h-0.5 bg-amber-400"></div>
                </div>
            </div>
            ...
            <div className="text-center relative z-10 mb-8 sm:mb-10">
                <p className="text-gray-500 text-xs sm:text-sm mb-4 font-medium">Dengan ini menyatakan bahwa</p>
                <h2 className="text-xl sm:text-3xl font-black text-gray-900 mb-4 border-b-2 border-amber-200 pb-3 inline-block px-4 sm:px-8">
                    {user?.username || 'Nama Peserta'}
                </h2>
                <p className="text-gray-600 text-sm sm:text-base mt-4 leading-relaxed max-w-lg mx-auto">
            ...
            {/* Details */}
            <div className="grid grid-cols-1 gap-4 sm:flex sm:justify-center sm:gap-8 md:gap-12 mb-8 sm:mb-10 relative z-10">
            ...
            {/* Signature Line */}
            <div className="flex flex-col sm:flex-row justify-between items-center sm:items-end gap-6 sm:gap-0 px-4 sm:px-8 relative z-10 pt-6 border-t border-amber-100">
                <div className="text-center">
                    <div className="w-32 h-0.5 bg-gray-300 mb-2 mx-auto"></div>
                    <p className="text-xs font-bold text-gray-500">Instruktur</p>
                </div>
                <div className="text-3xl sm:text-4xl"><TranslateIcon className="w-6 h-6 inline-block" /></div>
                <div className="text-center">
                    <div className="w-32 h-0.5 bg-gray-300 mb-2 mx-auto"></div>
