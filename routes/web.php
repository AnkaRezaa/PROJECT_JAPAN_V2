...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/exams/question-banks/picker', [AdminExamQuestionBankController::class, 'picker'])->name('exams.question-banks.picker');
        Route::get('/exams/question-banks/{bank}', [AdminExamQuestionBankController::class, 'show'])->name('exams.question-banks.show');
        Route::patch('/exams/question-banks/{bank}', [AdminExamQuestionBankController::class, 'update'])->name('exams.question-banks.update');
        Route::delete('/exams/question-banks/{bank}', [AdminExamQuestionBankController::class, 'destroy'])->name('exams.question-banks.destroy');
        Route::post('/exams/question-banks/{bank}/wrappers', [AdminExamQuestionBankController::class, 'storeWrapper'])->name('exams.question-banks.wrappers.store');
        Route::patch('/exams/question-banks/wrappers/{wrapper}', [AdminExamQuestionBankController::class, 'updateWrapper'])->name('exams.question-banks.wrappers.update');
        Route::delete('/exams/question-banks/wrappers/{wrapper}', [AdminExamQuestionBankController::class, 'destroyWrapper'])->name('exams.question-banks.wrappers.destroy');
        Route::post('/exams/question-banks/{bank}/questions', [AdminExamQuestionBankController::class, 'storeQuestion'])->name('exams.question-banks.questions.store');
        Route::patch('/exams/question-banks/questions/{question}', [AdminExamQuestionBankController::class, 'updateQuestion'])->name('exams.question-banks.questions.update');
        Route::delete('/exams/question-banks/questions/{question}', [AdminExamQuestionBankController::class, 'destroyQuestion'])->name('exams.question-banks.questions.destroy');
        Route::post('/exams/question-banks/{bank}/import/preview', [AdminExamQuestionBankController::class, 'importPreview'])->middleware('throttle:admin-imports')->name('exams.question-banks.import.preview');
        Route::post('/exams/question-banks/{bank}/import', [AdminExamQuestionBankController::class, 'import'])->middleware('throttle:admin-imports')->name('exams.question-banks.import');
        Route::post('/exam-sections/{section}/pull-questions', [AdminExamQuestionBankController::class, 'pullQuestions'])->name('exam-sections.questions.pull');
